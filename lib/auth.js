...
const PERMISOS = [
  ...
  { clave: 'tab.metricas', etiqueta: 'Métricas' },
  { clave: 'tab.seguimiento', etiqueta: 'Seguimiento' },
  { clave: 'tab.informe', etiqueta: 'Informe' },
...
const PERFILES = {
  ...
  lider: {
    ...
    porDefecto: [
      ...
      'tab.recursos', 'tab.capacity', 'tab.costos', 'tab.metricas', 'tab.seguimiento', 'tab.informe', 'dato.margen',
    ],
